...
public class ProductoControllerTest {
 ...
 public void testListarProductos() {
     ...
     // Verifica que la respuesta tenga un código de estado 200 (OK) y que el cuerpo contenga la lista de productos.
 ...
 public void testGuardarProducto() {
     ...
     // Verifica que la respuesta tenga un código de estado 200 (OK) y que el cuerpo contenga el producto guardado.
     assertEquals(200, response.getStatusCodeValue());
 ...
 public void testEliminarProducto() {
     ...
     // Verifica que la respuesta tenga un código de estado 200 (OK) y un mensaje de éxito.
     assertEquals(200, response.getStatusCodeValue());
